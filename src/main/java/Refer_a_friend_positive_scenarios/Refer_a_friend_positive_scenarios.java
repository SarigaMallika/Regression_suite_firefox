...
public class Refer_a_friend_positive_scenarios extends Generic_function{
	...
	public static WebElement first,second,third;
	...
	public static void grid_slideer() throws Exception   {
		try {
			first = driver.findElement(By.xpath(OR_reader("Object_locator", "refer_a_frnd_first_grid_text")));
			second= driver.findElement(By.xpath(OR_reader("Object_locator", "refer_a_frnd_second_grid_text")));
			third = driver.findElement(By.xpath(OR_reader("Object_locator", "refer_a_frnd_third_grid_text")));
			driver_name = browser_name();
			if(driver_name.equals("geck"))
			{
				firefox_slide_refer_frnd(first,second);
			}
			else{
				chrome_edge_slide_refer_frnd(first,third,second);
			}
			Thread.sleep(1000);
			value1 = driver.findElement(By.xpath(OR_reader("Object_Locator", "refer_a_frnd_third_grid_text"))).isDisplayed();
			Assert.assertEquals(true,value);
